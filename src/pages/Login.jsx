      ...
      <div className='w-full md:w-auto flex gap-0 md:gap-40 flex-col md:flex-row items-center justify-center'>
        ...
        <div className='w-full h-full lg:w-2/3 flex flex-col items-center justify-center'>
          <div className='w-full md:max-w-lg 2xl:max-w-3xl flex flex-col items-center justify-center gap-5 md:gap-y-10 2xl:mt-20'>
            <span className='flex gap-1 py-1 px-3  rounded-full border text-sm md:text-base border-gray-300 text-gray-600'>
        ...
        {/* right side */}
        <div className='w-full md:w-1/3 flex flex-col p-4 md:p-1 items-center justify-center'>
...
// this i should paste in login to go to Dashboard without login only
//  for developer to used it during coding
